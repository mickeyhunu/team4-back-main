...
const mqtt_connect_1 = {    //connecting mqtt & reading from plc
        ...
        this.client.on('message', async (topic, payload) => {
          ...
          try{
            ...
            try{
              ...
              // console.log(await productService.currentidinfo(params))
              ...
              dice = params.No2_Action
              if(dice == true && prev_dice == false){
                const _dice = Math.floor(Math.random() * 7) // 임의의 값
                if(_dice == 1 || _dice == 0){
                  const _params = {
                    dice: _dice,
                    fair: "false"
...
module.exports = { mqtt_connect_1, mqtt_connect_2};